...
namespace gMediaTools.MediaInfo
{
    ...
    public class gMediaInfo : IDisposable
    {
        ...
        public List<ChaptersTrack> ChaptersTracks
        {
            get
            {
                return GetChapterTracks();
            }
        }
        ...
        private string ListEveryAvailablePropery<T>(List<T> trackList)
        {
        ...
        private string GetCustomInfo()
        {
            if (string.IsNullOrWhiteSpace(_InfoCustom))
            {
                ...
                if (ChaptersTracks != null && ChaptersTracks.Count > 0)
                {
        ...
        private List<GeneralTrack> GetGeneralTracks()
        {
            if (_GeneralTracks != null)
            {
                return _GeneralTracks;
            }
        ...
        private List<VideoTrack> GetVideoTracks()
        {
        ...
        private List<TextTrack> GetTextTracks()
        {
            if (_TextTracks != null)
            {
                return _TextTracks;
        ...
        private List<ChaptersTrack> GetChapterTracks()
        {
            if (_ChaptersTracks != null)
            {
                return _ChaptersTracks;
            }
