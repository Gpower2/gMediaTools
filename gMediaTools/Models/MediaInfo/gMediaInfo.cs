    ...
    public class gMediaInfo : IDisposable
    {
        ...
        private void LoadVideoTracks()
        {
            ...
            for (int currentTrack = 0; currentTrack < trackCount; currentTrack++)
            {
                ...
                tmpVideoTrack.Count = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Count");
                tmpVideoTrack.StreamCount = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "StreamCount");
                tmpVideoTrack.StreamKind = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "StreamKind");
                tmpVideoTrack.StreamKindID = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "StreamKindID");
                tmpVideoTrack.StreamOrder = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "StreamOrder");
                tmpVideoTrack.StreamSize = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "StreamSize");
                tmpVideoTrack.Inform = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Inform");
                tmpVideoTrack.ID = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "ID");
                tmpVideoTrack.UniqueID = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "UniqueID");
                tmpVideoTrack.Title = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Title");
                tmpVideoTrack.Codec = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Codec");
                tmpVideoTrack.CodecString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Codec/String");
                tmpVideoTrack.CodecInfo = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Codec/Info");
                tmpVideoTrack.CodecUrl = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Codec/Url");
                tmpVideoTrack.CodecID = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "CodecID");
                tmpVideoTrack.CodecIDInfo = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "CodecID/Info");
                tmpVideoTrack.BitRate = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "BitRate");
                tmpVideoTrack.BitRateString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "BitRate/String");
                tmpVideoTrack.BitRateMode = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "BitRate_Mode");
                tmpVideoTrack.BitRateNominal = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "BitRate_Nominal");
                tmpVideoTrack.BitRateNominalString = GetSpecificMediaInfo(MediaInfoStreamKind.Audio, currentTrack, "BitRate_Nominal/String");
                tmpVideoTrack.EncodedLibrary = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Encoded_Library");
                tmpVideoTrack.EncodedLibrarySettings = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Encoded_Library_Settings");
                tmpVideoTrack.Width = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Width");
                tmpVideoTrack.Height = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Height");
                tmpVideoTrack.AspectRatio = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "AspectRatio");
                tmpVideoTrack.AspectRatioString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "AspectRatio/String");
                tmpVideoTrack.PixelAspectRatio = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "PixelAspectRatio");
                tmpVideoTrack.PixelAspectRatioString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "PixelAspectRatio/String");
                tmpVideoTrack.FrameRate = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "FrameRate");
                tmpVideoTrack.FrameRateString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "FrameRate/String");
                tmpVideoTrack.FrameRateOriginal = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "FrameRate_Original");
                tmpVideoTrack.FrameRateOriginalString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "FrameRate_Original/String");
                tmpVideoTrack.FrameRateMode = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "FrameRate_Mode");
                tmpVideoTrack.FrameRateModeString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "FrameRate_Mode/String");
                tmpVideoTrack.FrameCount = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "FrameCount");
                tmpVideoTrack.BitDepth = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "BitDepth");
                tmpVideoTrack.BitsPixelFrame = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Bits/(Pixel*Frame)");
                tmpVideoTrack.Delay = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Delay");
                tmpVideoTrack.Duration = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Duration");
                tmpVideoTrack.DurationString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Duration/String");
                tmpVideoTrack.DurationString1 = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Duration/String1");
                tmpVideoTrack.DurationString2 = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Duration/String2");
                tmpVideoTrack.DurationString3 = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Duration/String3");
                tmpVideoTrack.Language = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Language");
                tmpVideoTrack.LanguageString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Language/String");
                tmpVideoTrack.LanguageMore = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Language_More");
                tmpVideoTrack.Format = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format");
                tmpVideoTrack.FormatInfo = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format/Info");
                tmpVideoTrack.FormatProfile = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Profile");
                tmpVideoTrack.FormatSettings = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings");
                tmpVideoTrack.FormatSettingsBVOP = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_BVOP");
                tmpVideoTrack.FormatSettingsBVOPString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_BVOP/String");
                tmpVideoTrack.FormatSettingsCABAC = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_CABAC");
                tmpVideoTrack.FormatSettingsCABACString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_CABAC/String");
                tmpVideoTrack.FormatSettingsGMC = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_GMC");
                tmpVideoTrack.FormatSettingsGMCString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_GMAC/String");
                tmpVideoTrack.FormatSettingsMatrix = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_Matrix");
                tmpVideoTrack.FormatSettingsMatrixData = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_Matrix_Data");
                tmpVideoTrack.FormatSettingsMatrixString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_Matrix/String");
                tmpVideoTrack.FormatSettingsPulldown = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_Pulldown");
                tmpVideoTrack.FormatSettingsQPel = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_QPel");
                tmpVideoTrack.FormatSettingsQPelString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_QPel/String");
                tmpVideoTrack.FormatSettingsRefFrames = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_RefFrames");
                tmpVideoTrack.FormatSettingsRefFramesString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Settings_RefFrames/String");
                tmpVideoTrack.ScanType = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "ScanType");
                tmpVideoTrack.ScanTypeString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "ScanType/String");
                tmpVideoTrack.FormatUrl = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format/Url");
                tmpVideoTrack.FormatVersion = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Format_Version");
                tmpVideoTrack.Default = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Default");
                tmpVideoTrack.DefaultString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Default/String");
                tmpVideoTrack.Forced = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Forced");
                tmpVideoTrack.ForcedString = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Forced/String");
                tmpVideoTrack.ColorSpace = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "ColorSpace");
                tmpVideoTrack.ChromaSubsampling = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "ChromaSubsampling");
                tmpVideoTrack.Rotation = GetSpecificMediaInfo(MediaInfoStreamKind.Video, currentTrack, "Rotation");
