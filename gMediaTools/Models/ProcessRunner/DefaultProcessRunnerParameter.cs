...
{
    public class DefaultProcessRunnerParameter : IProcessRunnerParameter
    {
        ...
        public bool AllowsEmptyValues { get; }
        public bool ValueOnlyOutput { get; } = false;
        public bool Include { get; set; } = false;

        public Func<string, string> ProcessValue { get; set; }

        public DefaultProcessRunnerParameter(string name, string namePrefix, string nameValueSeparator, bool valueNeedsToBeQuoted, bool allowsEmptyValues, Func<string, string> processValue = null)
        {
